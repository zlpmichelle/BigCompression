...
import org.apache.hadoop.io.orc.ColumnStatistics;
import org.apache.hadoop.io.orc.CompressionKind;
import org.apache.hadoop.io.orc.Reader;
...
final class ReaderImpl implements Reader {
  ...
  private static class StripeInformationImpl implements StripeInformation {
    ...
    public String toString() {
      return "offset: " + getOffset() + " data: " + getDataLength() + " rows: "
          + getNumberOfRows() + " tail: " + getFooterLength() + " index: "
          + getIndexLength();
    }
  }
  ...
  @Override
  public Iterable<org.apache.hadoop.io.orc.StripeInformation> getStripes() {
    return new Iterable<org.apache.hadoop.io.orc.StripeInformation>() {

      @Override
      public Iterator<org.apache.hadoop.io.orc.StripeInformation> iterator() {
        return new Iterator<org.apache.hadoop.io.orc.StripeInformation>() {
          private final Iterator<OrcProto.StripeInformation> inner = footer
              .getStripesList().iterator();
          ...
          @Override
          public org.apache.hadoop.io.orc.StripeInformation next() {
            return (org.apache.hadoop.io.orc.StripeInformation) new StripeInformationImpl(
                inner.next());
          }
  ...
  public RecordReader rows(long offset, long length, boolean[] include)
    ...
    return new RecordReaderImpl(this.getStripes(), fileSystem, path, offset,
        length, footer.getTypesList(), codec, bufferSize, include,
