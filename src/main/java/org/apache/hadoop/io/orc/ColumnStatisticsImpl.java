...
import org.apache.hadoop.io.orc.BooleanColumnStatistics;
import org.apache.hadoop.io.orc.ColumnStatistics;
import org.apache.hadoop.io.orc.DecimalColumnStatistics;
import org.apache.hadoop.io.orc.DoubleColumnStatistics;
import org.apache.hadoop.io.orc.IntegerColumnStatistics;
import org.apache.hadoop.io.orc.StringColumnStatistics;
...
class ColumnStatisticsImpl implements ColumnStatistics {
  ...
  private static final class BooleanStatisticsImpl extends ColumnStatisticsImpl
    ...
    OrcProto.ColumnStatistics.Builder serialize() {
      ...
      OrcProto.BucketStatistics.Builder bucket = OrcProto.BucketStatistics
          .newBuilder();
  ...
  private static final class IntegerStatisticsImpl extends ColumnStatisticsImpl
    ...
    OrcProto.ColumnStatistics.Builder serialize() {
      OrcProto.ColumnStatistics.Builder builder = super.serialize();
      OrcProto.IntegerStatistics.Builder intb = OrcProto.IntegerStatistics
          .newBuilder();
      if (hasMinimum) {
  ...
  private static final class DoubleStatisticsImpl extends ColumnStatisticsImpl
    ...
    OrcProto.ColumnStatistics.Builder serialize() {
      OrcProto.ColumnStatistics.Builder builder = super.serialize();
      OrcProto.DoubleStatistics.Builder dbl = OrcProto.DoubleStatistics
          .newBuilder();
      if (hasMinimum) {
  ...
  private static final class StringStatisticsImpl extends ColumnStatisticsImpl
    ...
    OrcProto.ColumnStatistics.Builder serialize() {
      ...
      OrcProto.StringStatistics.Builder str = OrcProto.StringStatistics
          .newBuilder();
  ...
  private static final class DecimalStatisticsImpl extends ColumnStatisticsImpl
    ...
    OrcProto.ColumnStatistics.Builder serialize() {
      OrcProto.ColumnStatistics.Builder result = super.serialize();
      OrcProto.DecimalStatistics.Builder dec = OrcProto.DecimalStatistics
          .newBuilder();
      if (getNumberOfValues() != 0) {
  ...
  OrcProto.ColumnStatistics.Builder serialize() {
    OrcProto.ColumnStatistics.Builder builder = OrcProto.ColumnStatistics
        .newBuilder();
