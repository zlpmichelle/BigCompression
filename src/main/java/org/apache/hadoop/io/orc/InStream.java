...
abstract class InStream extends InputStream {
  ...
  private static class UncompressedStream extends InStream {
    ...
    public String toString() {
      return "uncompressed stream " + name + " base: " + base + " offset: "
          + offset + " limit: " + limit;
    }
  }
  ...
  private static class CompressedStream extends InStream {
    ...
    public int read(byte[] data, int offset, int length) throws IOException {
      ...
      System.arraycopy(uncompressed.array(), uncompressed.arrayOffset()
          + uncompressed.position(), data, offset, actualLength);
    ...
    public String toString() {
      return "compressed stream "
          ...
          + " limit: "
          + limit
          + (uncompressed == null ? "" : " uncompressed: "
              + uncompressed.position() + " to " + uncompressed.limit());
    }
  }
