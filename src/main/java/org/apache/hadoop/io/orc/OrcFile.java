...
public final class OrcFile {
   ...
   *          the number of rows between row index entries or 0 to suppress all
   *          indexes
   * @return a new ORC file streamFactory
   * @throws IOException
   */
  public static Writer createWriter(FileSystem fs, Path path,
      Configuration conf, ObjectInspector inspector, long stripeSize,
      CompressionKind compress, int bufferSize, int rowIndexStride)
      throws IOException {
